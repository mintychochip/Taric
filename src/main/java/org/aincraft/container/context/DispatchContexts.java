...
public final class DispatchContexts {
  ...
  static {
    BLOCK_BREAK = new DispatchContext<>(TriggerTypes.BLOCK_BREAK, ContextProviders.BLOCK_BREAK,
        IOnBlockBreak::onBlockBreak);
    BLOCK_DROP = new DispatchContext<>(TriggerTypes.BLOCK_DROP, ContextProviders.BLOCK_DROP,
        IOnBlockDrop::onBlockDrop);
    INTERACT = new DispatchContext<>(TriggerTypes.INTERACT, ContextProviders.INTERACT,
        IOnInteract::onInteract);
    PLAYER_SHEAR_ENTITY = new DispatchContext<>(TriggerTypes.PLAYER_SHEAR_ENTITY,
        ContextProviders.PLAYER_SHEAR_ENTITY, IOnPlayerShearEntity::onPlayerShear);
    ENTITY_HIT_ENTITY = new DispatchContext<>(TriggerTypes.ENTITY_HIT_ENTITY,
        ContextProviders.ENTITY_DAMAGE_BY_ENTITY, IOnEntityHitEntity::onHitEntity);
    ENTITY_HIT_BY_ENTITY = new DispatchContext<>(TriggerTypes.ENTITY_HIT_BY_ENTITY,
        ContextProviders.ENTITY_DAMAGE_BY_ENTITY, IOnEntityHitByEntity::onHitByEntity);
    PLAYER_FISH = new DispatchContext<>(TriggerTypes.PLAYER_FISH, ContextProviders.PLAYER_FISH,
        IOnPlayerFish::onPlayerFish);
    KILL_ENTITY = new DispatchContext<>(TriggerTypes.ENTITY_KILL, ContextProviders.ENTITY_KILL,
        IOnEntityKill::onKillEntity);
    ENTITY_MOVE = new DispatchContext<>(TriggerTypes.ENTITY_MOVE, ContextProviders.ENTITY_MOVE,
        IOnEntityMove::onEntityMove);
    PLAYER_MOVE = new DispatchContext<>(TriggerTypes.PLAYER_MOVE, ContextProviders.PLAYER_MOVE,
        IOnPlayerMove::onPlayerMove);
    PLAYER_ITEM_DAMAGE = new DispatchContext<>(TriggerTypes.PLAYER_ITEM_DAMAGE,
        ContextProviders.PLAYER_ITEM_DAMAGE, IOnPlayerItemDamage::onPlayerItemDamage);
    ENTITY_ITEM_DAMAGE = new DispatchContext<>(TriggerTypes.ENTITY_ITEM_DAMAGE,
        ContextProviders.ENTITY_ITEM_DAMAGE, IOnEntityItemDamage::onEntityItemDamage);
    SHOOT_BOW = new DispatchContext<>(TriggerTypes.SHOOT_BOW, ContextProviders.SHOOT_BOW,
        IOnShootBow::onShootBow);
  }
