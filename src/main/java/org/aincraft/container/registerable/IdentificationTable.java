...
final class IdentificationTable extends AbstractRegisterable implements IIdentificationTable {
  ...
  private final IRandomSelector<Rarity> randomSelector;

  public IdentificationTable(Key key, IRandomSelector<Rarity> randomSelector) {
    super(key);
    this.randomSelector = randomSelector;
  }

  @Override
  public @NotNull Rarity getRandom(RandomGenerator randomGenerator) {
